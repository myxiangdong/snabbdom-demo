...
function movieView (movie) {
  return h('div.row', {
    ...
    h('div', movie.title),
    h('div', movie.desc),
    h('div.btn.rm-btn', { on: { click: function(){remove(movie)} } }, 'x'),
  ])
}
...
function view (data) {
  return h('div', [
    ...
    h('div', [
      ...
      'Sort by: ',
      h('span.btn-group', [
        h('a.btn.rank', { class: { active: sortBy === 'rank' }, on: { click: function(){changeSort('rank')} } }, 'Rank'),
        h('a.btn.title', { class: { active: sortBy === 'title' }, on: { click: function(){changeSort('title')} } }, 'Title'),
        h('a.btn.desc', { class: { active: sortBy === 'desc' }, on: { click: function(){changeSort('desc')} } }, 'Description'),
      ]),
    ]),
